...
It used to be a lot easier to learn when all we had were expositional texts. The type of media we could learn from were limited, and as a result, we didn't need to learn many ways of learning.
...
1. **Inspectional** - you're skimming the text. The aim is to find out, at a high level, what the book can offer you and to formulate the questions you have. Your first pass reading is unlikely to be linear, and your second pass reading is likely to still leave gaps in your understanding. It's also possible you skipped entire sections because it's not relevant to your learning yet.
2. **Analytical** - you're ready to answer questions. You know what questions you have, and you're reading the book again with the intent to answer those questions.
3. **Syntopical** - you've read the book many times and have a good idea of where to find the information you need when you need it. It's possible you may still have some outstanding questions from the previous stage (if not more), and you're not satisfied that this book answers all your questions. At this stage, you start to look for other sources of text to answer your remaining questions. You restart the cycle with the new text source and your questions/notes are formulated with references to the previous text.
